...
export default function Toolbar(props) {
  ...
  const toolbarItems = {
    left: [
      {
        title: "Rückgängig",
        onClick: () => props.editorUndo(),
        isDisabled: () => props.toolbarStatus.editorHistory.undo <= 0,
        icon: faReply
      },
      {
        title: "Wiederholen",
        onClick: () => props.editorRedo(),
        isDisabled: () => props.toolbarStatus.editorHistory.redo <= 0,
        icon: faShare
      },
      { separator: true },
      {
        title: "Fett",
        onClick: () => props.boldClick(),
        icon: faBold
      },
      {
        title: "Kursiv",
        onClick: () => props.italicClick(),
        icon: faItalic
      },
      {
        title: "Unterstreichen",
        onClick: () => props.underlineClick(),
        icon: faUnderline
      },
      {
        title: "Schriftfarbe ändern",
        onClick: null,
        icon: faFont
      },
      { separator: true },
